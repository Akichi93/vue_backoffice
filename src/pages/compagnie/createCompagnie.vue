                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <inputText :placeholder="'Entrez le nom de la compagnie'" v-model="form.nom_compagnie">
                          </inputText>

                          <p style="color: red" class="text-red" v-if="errors.nom_compagnie"
                            v-text="errors.nom_compagnie"></p>
                        </div>
                        <div class="form-group">
                          <label>Contact</label>
                          <inputText :placeholder="'Entrez le contact de la compagnie'" v-model="form.contact_compagnie">
                          </inputText>
                          <p style="color: red" class="text-red" v-if="errors.contact_compagnie"
                            v-text="errors.contact_compagnie"></p>
                        </div>
                        <div class="form-group">
                          <label>Code postal</label>
                          <inputText :placeholder="'Entrez le code postal de la compagnie'"
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label>Email</label>
                              <inputText :placeholder="'Entrez l\'email de la compagnie'" v-model="form.email_compagnie">
                              </inputText>
                              <p style="color: red" class="text-red" v-if="errors.email_compagnie"
                                v-text="errors.email_compagnie"></p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-9">
                            <div class="form-group">
                              <label>Adresse</label>
                              <Multiselect v-model="form.adresse_compagnie" :options="localisations" :custom-label="({ id_localisation, nom_ville }) =>
                              ...
                              <p style="color: red" class="text-red" v-if="errors.adresse_compagnie"
                                v-text="errors.adresse_compagnie"></p>
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
