          ...
          <div class="col-md-12">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <h5 class="card-title">Désignation des Garanties</h5>
                    ...
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th class="designation-vertical">Couvert ou Exclu</th>
                      ...
                      <tbody>
                        ...
                        <tr class="highlight-row">
                          ...
                          <td class="designation-vertical">COUVERT</td>
                        ...
                        <tr>
                          ...
                          <td lass="designation-vertical">COUVERT</td>
                          <td class="capital">1 an de loyer</td>
