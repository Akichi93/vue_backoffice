...
export const useAutofileStore = defineStore('autofile', {
  state: () => ({
    selectedFile: null,
    loading: false,
    progress: 0,
  ...
  actions: {
    ...
    async uploadFile(axios) {
      ...
      try {
        ...
        await axios.post('/api/auth/importautomobile', formData, {
          headers,
        ...
        this.toaster.success("Base apporteur importé avec succès.", {
          position: "top-right",
        });
      } catch (error) {
