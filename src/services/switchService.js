...
class switchService {
  ...
  async updateBranche(branchetoedit, uuidBrancheToUpdate) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateBranche(
          branchetoedit,
          uuidBrancheToUpdate
        );
      } else if (this.currentMode === "Ligne") {
        const response = await onlineService.updateBranche(
          branchetoedit,
          uuidBrancheToUpdate
        );
        return response.data;
  ...
  async storeProspect(formData, userId, entrepriseId) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.storeProspect(
          formData,
          userId,
          entrepriseId
        );
      } else if (this.currentMode === "Ligne") {
        return await onlineService.storeProspect(
          formData,
          userId,
          entrepriseId
        );
  ...
  async ChangeEtat(uuidProspectToUpdate, nouveauStatut, nouveauSyncState) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.ChangeEtat(
          uuidProspectToUpdate,
          nouveauStatut,
          nouveauSyncState
        );
      } else if (this.currentMode === "Ligne") {
        return await onlineService.ChangeEtat(
          uuidProspectToUpdate,
          nouveauStatut,
          nouveauSyncState
        );
  ...
  async updateProspect(prospectoedit, uuidProspectToUpdate) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateProspect(
          prospectoedit,
          uuidProspectToUpdate
        );
      } else if (this.currentMode === "Ligne") {
        const response = await onlineService.updateProspect(
          prospectoedit,
          uuidProspectToUpdate
        );
        return response.data;
  ...
  async changeProspect(
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.changeProspect(
          uuidProspectToUpdate,
          newState,
          newSyncState,
          prospectoedit,
        ...
        return await onlineService.changeProspect(
          uuidProspectToUpdate,
          newState,
          newSyncState,
          prospectoedit,
  ...
  async deleteProspect(uuidProspectToUpdate, newDelete, newSyncState) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.deleteProspect(
          uuidProspectToUpdate,
          newDelete,
          newSyncState
        );
      } else if (this.currentMode === "Ligne") {
        return await onlineService.deleteProspect(
          uuidProspectToUpdate,
          newDelete,
          newSyncState
        );
  ...
  async getBrancheProspectsByuuidProspect(uuidProspect) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.getBrancheProspectsByuuidProspect(
          uuidProspect
        );
      } else if (this.currentMode === "Ligne") {
        return await onlineService.getBrancheProspectsByuuidProspect(
          uuidProspect
        );
      } else {
        throw new Error("Unsupported mode: " + this.currentMode);
  ...
  async addProspectBranche(form, userId, entrepriseId, uuidProspect) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.addProspectBranche(
          form,
          userId,
          entrepriseId,
          uuidProspect
        ...
        return await onlineService.addProspectBranche(
          form,
          userId,
          entrepriseId,
          uuidProspect
  ...
  async storeClient(form, entrepriseId, userId, numeroClient) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.storeClient(
          form,
          entrepriseId,
          userId,
          numeroClient
        ...
        return await onlineService.storeClient(
          form,
          entrepriseId,
          userId,
          numeroClient
  ...
  async updateClient(clientoedit, uuidClientToUpdate) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateClient(
          clientoedit,
          uuidClientToUpdate
        );
      } else if (this.currentMode === "Ligne") {
        return await onlineService.updateClient(
          clientoedit,
          uuidClientToUpdate
        );
      } else {
  ...
  async storeApporteur(
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.storeApporteur(
          form,
          userId,
          entrepriseId,
          codeApporteur,
        ...
        return await onlineService.storeApporteur(
          form,
          userId,
          entrepriseId,
          codeApporteur,
  ...
  async updateApporteur(apporteurtoedit, uuidApporteurToUpdate) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateApporteur(
          apporteurtoedit,
          uuidApporteurToUpdate
        );
      } else if (this.currentMode === "Ligne") {
        return await onlineService.updateApporteur(
          apporteurtoedit,
          uuidApporteurToUpdate
        );
      } else {
  ...
  async updateTauxApporteur(
    uuidTauxApporteurUpdate,
    newTaux,
    newSyncState,
    uuidApporteur
  ) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateTauxApporteur(
          uuidTauxApporteurUpdate,
          newTaux,
          newSyncState,
          uuidApporteur
        ...
        return await onlineService.updateTauxApporteur(
          uuidTauxApporteurUpdate,
          newTaux,
          newSyncState,
          uuidApporteur
  ...
  async updateAvenantPayerApporteur(
    uuidAvenantToUpdate,
    newPayer,
    newSyncState,
    uuidApporteur
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateAvenantPayerApporteur(
          uuidAvenantToUpdate,
          newPayer,
          newSyncState,
          uuidApporteur
        ...
        return await onlineService.updateAvenantPayerApporteur(
          uuidAvenantToUpdate,
          newPayer,
          newSyncState,
          uuidApporteur
  ...
  async updateAvenantPayerCompagnie(
    uuidAvenantToUpdate,
    newPayer,
    newSyncState,
    uuidApporteur
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateAvenantPayerCompagnie(
          uuidAvenantToUpdate,
          newPayer,
          newSyncState,
          uuidApporteur
        ...
        return await onlineService.updateAvenantPayerCompagnie(
          uuidAvenantToUpdate,
          newPayer,
          newSyncState,
          uuidApporteur
  ...
  async storeCompagnie(form, userId, entrepriseId, unique, donnees, datas) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.storeCompagnie(
          form,
          userId,
          entrepriseId,
          unique,
        ...
        return await onlineService.storeCompagnie(
          form,
          userId,
          entrepriseId,
          unique,
  ...
  async updateCompagnie(compagnietoedit, uuidCompagnieToUpdate, entrepriseId) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateCompagnie(
          compagnietoedit,
          uuidCompagnieToUpdate,
          entrepriseId
        );
      } else if (this.currentMode === "Ligne") {
        return await onlineService.updateCompagnie(
          compagnietoedit,
          uuidCompagnieToUpdate,
          entrepriseId
        );
  ...
  async updateContrat(
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateContrat(
          contrats,
          uuidContratToUpdate,
          primeNette,
          accessoires,
        ...
        return await onlineService.updateContrat(
          contrats,
          uuidContratToUpdate,
          primeNette,
          accessoires,
  ...
  async storeContrat(
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.storeContrat(
          form,
          userId,
          entrepriseId,
          commission_courtier,
        ...
        return await onlineService.storeContrat(
          form,
          userId,
          entrepriseId,
          commission_courtier,
  ...
  async getTauxParIdBrancheEtCompagnie(id_branche, option) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.getTauxParIdBrancheEtCompagnie(
          id_branche,
          option
        );
      } else if (this.currentMode === "Ligne") {
        return await onlineService.getTauxParIdBrancheEtCompagnie(
          id_branche,
          option
        );
      } else {
  ...
  async getTauxParIdBrancheEtApporteur(id_branche, optional) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.getTauxParIdBrancheEtApporteur(
          id_branche,
          optional
        );
      } else if (this.currentMode === "Ligne") {
        return await onlineService.getTauxParIdBrancheEtApporteur(
          id_branche,
          optional
        );
      } else {
  ...
  async storeAutomobile(
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.storeAutomobile(
          form,
          userId,
          entrepriseId,
          uuidAutomobile,
        ...
        return await onlineService.storeAutomobile(
          form,
          userId,
          entrepriseId,
          uuidAutomobile,
  ...
  async storeAvenant(
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.storeAvenant(
          form,
          userId,
          entrepriseId,
          uuidContrat,
        ...
        return await onlineService.storeAvenant(
          form,
          userId,
          entrepriseId,
          uuidContrat,
  ...
  async updateAvenantSolde(
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateAvenantSolde(
          uuidContrat,
          uuidAvenantToUpdate,
          newSolde,
          newSyncState
        ...
        return await onlineService.updateAvenantSolde(
          uuidContrat,
          uuidAvenantToUpdate,
          newSolde,
          newSyncState
  ...
  async updateAvenantReverse(
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateAvenantReverse(
          uuidContrat,
          uuidAvenantToUpdate,
          newReverse,
          newSyncState
        ...
        return await onlineService.updateAvenantReverse(
          uuidContrat,
          uuidAvenantToUpdate,
          newReverse,
          newSyncState
  ...
  async storeSinistre(form, userId, entrepriseId, police) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.storeSinistre(
          form,
          userId,
          entrepriseId,
          police
        ...
        return await onlineService.storeSinistre(
          form,
          userId,
          entrepriseId,
          police
  ...
  async updateSinistre(uuidSinistreToUpdate, sinistres) {
    ...
    try {
      if (this.currentMode === "Local") {
        return await offlineService.updateSinistre(
          uuidSinistreToUpdate,
          sinistres
        );
      } else if (this.currentMode === "Ligne") {
        return await onlineService.updateSinistre(
          uuidSinistreToUpdate,
          sinistres
        );
      } else {
